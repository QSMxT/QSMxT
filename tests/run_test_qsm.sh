...
[ -f /tmp/02_qsm_output/workflow_qsm/sub-170705-134431-std-1312211075243167001/ses-1/_run_run-1/mriresearchtools_correct-inhomogeneity/mapflow/_mriresearchtools_correct-inhomogeneity0/result__mriresearchtools_correct-inhomogeneity0.pklz ] && echo "[DEBUG]. Test OK." || exit 1
sudo rm -rf /tmp/02_qsm_output
