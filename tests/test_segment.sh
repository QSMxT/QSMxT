...
[ -f  segmentation/qsm_segmentations/sub-170706160506STD1312211075243167001_ses-20170706_run-01_T1w_segmentation_nii_trans.nii ] && echo "sub-170706160506STD1312211075243167001_ses-20170706_run-01_T1w_segmentation_nii_trans.nii exists." || exit 1
...
[ -f  analysis/sub-170706160506STD1312211075243167001_ses-20170706_run-01_T1w_segmentation_nii_trans.csv ] && echo "FILE exists." || exit 1
