...
[ -f  /tmp/${timeStamp}/03_segmentation/t1_segmentations/sub-170705134431STD1312211075243167001-1_run-01_T1w_segmentation_nii.nii ] && echo "sub-170705134431STD1312211075243167001-1_run-01_T1w_segmentation_nii.nii exists." || exit 1
[ -f  /tmp/${timeStamp}/03_segmentation/t1_segmentations/sub-170706160506STD1312211075243167001-1_run-01_T1w_segmentation_nii.nii ] && echo "sub-170706160506STD1312211075243167001-1_run-01_T1w_segmentation_nii.nii exists." || exit 1
[ -f  /tmp/${timeStamp}/03_segmentation/qsm_segmentations/sub-170705134431STD1312211075243167001-1_run-01_T1w_segmentation_nii_trans.nii ] && echo "sub-170705134431STD1312211075243167001-1_run-01_T1w_segmentation_nii_trans.nii exists." || exit 1
[ -f  /tmp/${timeStamp}/03_segmentation/qsm_segmentations/sub-170706160506STD1312211075243167001-1_run-01_T1w_segmentation_nii_trans.nii ] && echo "sub-170706160506STD1312211075243167001-1_run-01_T1w_segmentation_nii_trans.nii exists." || exit 1
...
[ -f  /tmp/${timeStamp}/05_analysis/sub-170705134431STD1312211075243167001-1_run-01_T1w_segmentation_nii_trans.csv ] && echo "FILE exists." || exit 1
[ -f  /tmp/${timeStamp}/05_analysis/sub-170706160506STD1312211075243167001-1_run-01_T1w_segmentation_nii_trans.csv ] && echo "FILE exists." || exit 1
