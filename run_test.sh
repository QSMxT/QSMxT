...
docker run -v /tmp:/tmp $container python3 /opt/QSMxT/run_0_dicomSort.py /tmp/dicoms /tmp/00_dicom
docker run -v /tmp:/tmp $container python3 /opt/QSMxT/run_1_dicomToBids.py /tmp/00_dicom /tmp/01_bids
docker run -v /tmp:/tmp $container python3 /opt/QSMxT/run_2_qsm.py /tmp/01_bids /tmp/02_qsm_output
...
# docker run -it -v /tmp:/tmp $container python3 /opt/QSMxT/run_4_magnitudeTemplate.py /tmp/01_bids /tmp/04_magnitude_template
