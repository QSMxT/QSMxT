...
docker run -it -v /tmp:/tmp vnmd/qsmxt_1.0.0:20210305 python3 /opt/QSMxT/run_0_dicomSort.py /tmp/dicoms /tmp/00_dicom
docker run -it -v /tmp:/tmp vnmd/qsmxt_1.0.0:20210305 python3 /opt/QSMxT/run_1_dicomToBids.py /tmp/00_dicom /tmp/01_bids
docker run -it -v /tmp:/tmp vnmd/qsmxt_1.0.0:20210305 python3 /opt/QSMxT/run_2_qsm.py /tmp/01_bids /tmp/02_qsm_output
