...
@add_arg_table! s begin
    ...
    "--type"
        help = """grad || multiecho || second || mag_coherence || mag_intensity
                  Different weights can be combined e.g. grad+second+mag_coherence"""
        default = "grad"
    "--output"
...
if contains(args["type"], "multiecho")
    weights[2] = true
end
...
if contains(args["type"], "mag_intensity")
    weights[5] = true
end
