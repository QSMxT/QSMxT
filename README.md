...
2. Install the QSMxT container via [transparent singularity](https://github.com/neurodesk/transparent-singularity):
    ...
    ```bash
    git clone https://github.com/NeuroDesk/transparent-singularity qsmxt_1.1.4_20210611
    cd qsmxt_1.1.4_20210611
    ./run_transparent_singularity.sh --container qsmxt_1.1.4_20210611.simg
    ```
...
```
docker run -it vnmd/qsmxt_1.1.4:20210611
```
