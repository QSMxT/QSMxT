...
```
bash /neurocommand/local/fetch_and_run.sh qsmxt 3.0.1 20230719
```
...
For Windows:
```
docker run -it -v C:/neurodesktop-storage:/neurodesktop-storage vnmd/qsmxt_3.0.1:20230719
```
For Linux/Mac:
```
docker run -it -v ~/neurodesktop-storage:/neurodesktop-storage vnmd/qsmxt_3.0.1:20230719
```
...
2. Install the QSMxT container via [transparent singularity](https://github.com/neurodesk/transparent-singularity):
    ...
    ```bash
    git clone https://github.com/NeuroDesk/transparent-singularity qsmxt_3.0.1_20230719
    cd qsmxt_3.0.1_20230719
    ./run_transparent_singularity.sh --container qsmxt_3.0.1_20230719.simg
    source activate_qsmxt_3.0.1_20230719.simg.sh
    ```
